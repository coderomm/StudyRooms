    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            var PropertiesData = (from p in db.Property_Table
                                  ...
                                  select new mix { property_id = p.property_id, owner_name = o.owner_name, property_name = p.property_name, property_type = p.property_type, property_purpose = p.property_purpose, property_price = p.property_price, property_rent = p.property_rent, property_address = p.property_address, property_image1 = p.property_image1, property_image2 = p.property_image2, property_image3 = p.property_image3, property_image4 = p.property_image4, property_image5 = p.property_image5, property_parking = p.property_parking, property_wifi = p.property_wifi, property_ac = p.property_ac, property_water_supply = p.property_water_supply, property_window = p.property_window, property_video = p.property_video, property_size = p.property_size, property_room_no = p.property_room_no, property_bathroom_no = p.property_bathroom_no, property_balcony_no = p.property_balcony_no, property_age = p.property_age }).ToList();
            ViewBag.PropertiesJoinData = PropertiesData;
            return View();
        }

        [HttpPost]
        public ActionResult Index(string DistrictId, string property_purpose, string property_type, string property_room_no)
        {
            if (property_purpose == "Sale")
            {
                ...
                return RedirectToAction("Index", "ExploreProperties");
            }
            if (property_purpose == "Rent")
            {
                var PropertiesData = (from p in db.Property_Table
        ...
        public JsonResult AutoComplete(string prefix)
        {
            ...
            //var customers = new SelectList(db.States.ToList()).Where(x=>x.);
